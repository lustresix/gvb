...
type UserModel struct {
	...
	ArticleModel  []ArticleModel   `gorm:"foreignKey:UserID" json:"-"`                                                         // 文章列表
	CollectsModel []ArticleModel   `gorm:"many2many:user_collect_models;joinForeignKey:AuthID;JoinReferences:UserID" json:"-"` // 收藏文章列表
}
